...
export const partyCards: MiniGame[] = [
  ...
  },
  {
    description: [
      ...
      "First player to build a house wins without it falling over wins.",
    ],
  ...
  },
  {
    description: [
      ...
      "Players take turns naming an item in the cateogry.",
      "If a you cannot name something or repeat an item thats already beeen said, you are out.",
  ...
  },
  {
    ...
    description: [
      "The drawing player picks a word.",
      "Players take turns saying a word that rhymes with the original word.",
      "If you cannot think of a word or repeats a word thats already been said, you are out.",
      "The last player standing wins!",
    ],
    reward: "1 point",
    icon: SiAudiomack,
  ...
  },
  {
    ...
    description: [
      ...
      "Roll a single die. If it lands on your number, you are out. Keep rolling until only one player is left.",
      "The last player standing wins!",
    ],
    reward: "1 point",
    icon: GiChaingun,
  ...
  },
  {
    ...
    description: [
      ...
      "If you make it, pass the quarter and shot glass to the player on your left.",
      "If the person to your immediate right makes it before you, you are out!",
      "The last player standing wins!",
    ],
    reward: "1 point",
    icon: GiBattleAxe,
  ...
  },
  {
    ...
    description: [
      "Lay down twice as many cards as there are players, face down. (minimum 8 cards)",
  ...
  },
  {
    ...
    description: [
      "Players take turns quoting a line from any movie.",
      "First player to guess correctly wins a point.",
  ...
  },
  {
    ...
    description: [
      'Players work together to count to 10, taking turns saying the next number in line. (ex: player 1 says "1", player 2 says "2", etc.)',
      "The player who says the last number chooses an existing number with a new.",
      "ex: the player who says last last number chooses to replace the number 2 with a rule that states you must say the number 2 in a different language.",
      "After the rule is established, the player who said the last number starts the count over at 1.",
      "Repeat until the group has replaced all numbers with custom rules.",
      "If a player messes up the count, they are out.",
      "All players who make it to the end of the count win a point.",
      "If no players make it to the end of the count, the player who made the last rule wins a point.",
    ],
    reward: "1 point",
    icon: GoNumber,
  },
  ...
  },
  {
    ...
    description: [
      "Drawing player makes up any rule they want!",
  ...
  },
  {
    ...
    description: [
      ...
      "At the start of the round, each player can state their case for why they are not the imposter. At the end of deliberation, everyone votes for who they think the imposter is. The player with the most votes is out and reveals their card.",
  ...
  },
  {
    ...
    description: [
      "Takes turns rolling a single die.",
      ...
      "If you roll your current number, move up a number and roll again.",
  ...
  },
  {
    ...
    description: [
      "The drawing player writes a phrase on a piece of paper.",
      "The next player attempts to draw a picture of the phrase.",
      "The next player writes a phrase based on the previously drawn picture.",
      "Repeat until each player has had a turn.",
      "If the round ends on the drawing phase, the person who drew first writes down one final phrase.",
  ...
  },
  {
    ...
    description: [
      "The drawing player picks any word or phrase.",
      "Other players take turns guessing letters.",
      "If a player guesses a letter correctly, the player who picked the word/phrase writes the letter in the correct spot. They may then attempt to guess the word/phrase.",
  ...
  },
  {
    ...
    description: [
      "The drawing player picks a 4-6 letter word and announces its letter count.",
  ...
  },
  {
    ...
    description: [
      ...
      "If you complete a 1x1 box, write your initial in that box.",
  ...
  },
  {
    ...
    description: [
      ...
      "5 - eyes",
      "6 - mouth",
      "Leg, arms, and head cannot be drawn until body is drawn.",
