...
import { Game, PLAYER_ACTION, PlayerAction } from '../types/types'
...
const getNextDefaultAction = (
  ...
  if (
    ...
    return {
      ...
      description: 'Exclaim GRANDMA or discard',
      actionTaken: null,
    }
  }
...
const getNextGrandmaAction = (
  ...
  if (
    ...
    const newAvailableActions = [PLAYER_ACTION.END_TURN]
...
const getNextCardPartyAction = (): PlayerAction | null => {
  // first action
  return {
    availableActions: [PLAYER_ACTION.REVEAL_CARD],
